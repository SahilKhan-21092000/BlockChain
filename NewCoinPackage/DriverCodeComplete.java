...
import java.util.*;
public class DriverCodeComplete {

    public static void main(String args[]) {

        // Expected output given below 
        
        NewCoin_Honest NewCObj = new NewCoin_Honest();
        NewCObj.pendingTransactions = new TransactionQueue();
        NewCObj.bChain = new BlockChain_Honest();
        Boolean correct = true;
        NewCObj.bChain.tr_count = 4;
        ...
        NewCObj.memberlist = new Members[4];
        NewCObj.memberlist[0] = m1;
        NewCObj.memberlist[1] = m2;
        NewCObj.memberlist[2] = m3;
        NewCObj.memberlist[3] = m4;

        Moderator mod = new Moderator();
        try {
            mod.initializeNewCoin(NewCObj, 8);
        } catch (Exception e) {
            System.out.println(e);
        }

        m1.initiateCoinsend("102", NewCObj);
        m3.initiateCoinsend("102", NewCObj);
        m3.initiateCoinsend("102", NewCObj);
        ...
        try {
            m2.MineCoin(NewCObj);
            temp = m1.finalizeCoinsend(NewCObj.bChain.lastBlock.trarray[0],NewCObj);
            temp = m3.finalizeCoinsend(NewCObj.bChain.lastBlock.trarray[2],NewCObj);
        } catch (Exception e) {
        }

        m2.initiateCoinsend("101", NewCObj);
        Transaction fake = new Transaction();
        fake.Source = m1;
        fake.Destination = m3;
        fake.coinsrc_block = NewCObj.bChain.lastBlock;
        fake.coinID = "100000";
        NewCObj.pendingTransactions.AddTransactions(fake);
        m2.initiateCoinsend("101", NewCObj);
        m4.initiateCoinsend("101", NewCObj);
        try {
            m3.MineCoin(NewCObj);
            Pair<List<Pair<String, String>>,List<Pair<String, String>>> temp1 = m2.finalizeCoinsend(NewCObj.bChain.lastBlock.trarray[0], NewCObj);
            temp1 = m2.finalizeCoinsend(NewCObj.bChain.lastBlock.trarray[1], NewCObj);
            temp1 = m4.finalizeCoinsend(NewCObj.bChain.lastBlock.trarray[2], NewCObj);
            temp = m3.finalizeCoinsend(NewCObj.bChain.lastBlock.previous.trarray[1],NewCObj);
        } catch (Exception e) {
            System.out.println(e);
        }
        ...
        correct &= NewCObj.bChain.lastBlock.dgst.equals("00004F4D8749BFFE9E1BEF4152F6849BCD0A529B463FF0D409B338AFABF690C8");
        ...
        NewCoin_Malicious NewCObj2 = new NewCoin_Malicious();
        NewCObj2.pendingTransactions = new TransactionQueue();
        NewCObj2.bChain = new BlockChain_Malicious();
        NewCObj2.bChain.lastBlocksList = new TransactionBlock[100];
        Boolean correct2 = true;
        NewCObj2.bChain.tr_count = 8;
        Members M1 = new Members();
        Members M2 = new Members();
        Members M3 = new Members();
        Members M4 = new Members();
        ...
        NewCObj2.memberlist = new Members[6];
        NewCObj2.memberlist[0] = M1;
        NewCObj2.memberlist[1] = M2;
        NewCObj2.memberlist[2] = M3;
        NewCObj2.memberlist[3] = M4;
        NewCObj2.memberlist[4] = M5;
        NewCObj2.memberlist[5] = M6;
        
        try {
            mod.initializeNewCoin(NewCObj2, 24);
        } catch (Exception e) {
            System.out.println(e);
        }
        System.out.println(NewCObj2.bChain.lastBlocksList[0].dgst);
        System.out.println(NewCObj2.bChain.lastBlocksList[0].nonce);
        ...
        T1.coinID = NewCObj2.memberlist[0].mycoins.get(0).get_first();
        T1.Source = NewCObj2.memberlist[0];
        T1.Destination = NewCObj2.memberlist[1];
        T1.coinsrc_block = NewCObj2.memberlist[0].mycoins.get(0).get_second();
        NewCObj2.pendingTransactions.AddTransactions(T1);

        T2.coinID = NewCObj2.memberlist[2].mycoins.get(0).get_first();
        T2.Source = NewCObj2.memberlist[2];
        T2.Destination = NewCObj2.memberlist[1];
        T2.coinsrc_block = NewCObj2.memberlist[2].mycoins.get(0).get_second();
        NewCObj2.pendingTransactions.AddTransactions(T2);

        T3.coinID = NewCObj2.memberlist[2].mycoins.get(1).get_first();
        T3.Source = NewCObj2.memberlist[2];
        T3.Destination = NewCObj2.memberlist[1];
        T3.coinsrc_block = NewCObj2.memberlist[2].mycoins.get(1).get_second();
        NewCObj2.pendingTransactions.AddTransactions(T3);

        T4.coinID = NewCObj2.memberlist[3].mycoins.get(0).get_first();
        T4.Source = NewCObj2.memberlist[3];
        T4.Destination = NewCObj2.memberlist[4];
        T4.coinsrc_block = NewCObj2.memberlist[3].mycoins.get(0).get_second();
        NewCObj2.pendingTransactions.AddTransactions(T4);

        T5.coinID = NewCObj2.memberlist[3].mycoins.get(1).get_first();
        T5.Source = NewCObj2.memberlist[3];
        T5.Destination = NewCObj2.memberlist[4];
        T5.coinsrc_block = NewCObj2.memberlist[3].mycoins.get(1).get_second();
        NewCObj2.pendingTransactions.AddTransactions(T5);

        T6.coinID = NewCObj2.memberlist[3].mycoins.get(2).get_first();
        T6.Source = NewCObj2.memberlist[3];
        T6.Destination = NewCObj2.memberlist[5];
        T6.coinsrc_block = NewCObj2.memberlist[3].mycoins.get(2).get_second();
        NewCObj2.pendingTransactions.AddTransactions(T6);

        T7.coinID = NewCObj2.memberlist[0].mycoins.get(1).get_first();
        T7.Source = NewCObj2.memberlist[0];
        T7.Destination = NewCObj2.memberlist[5];
        T7.coinsrc_block = NewCObj2.memberlist[0].mycoins.get(1).get_second();
        NewCObj2.pendingTransactions.AddTransactions(T7);

        T8.coinID = NewCObj2.memberlist[2].mycoins.get(2).get_first();
        T8.Source = NewCObj2.memberlist[2];
        T8.Destination = NewCObj2.memberlist[4];
        T8.coinsrc_block = NewCObj2.memberlist[2].mycoins.get(2).get_second();
        NewCObj2.pendingTransactions.AddTransactions(T8);

       
        try {
            M3.MineCoin(NewCObj2);
        } catch (Exception e) {
        }
        System.out.println(NewCObj2.bChain.lastBlocksList[0].dgst);
        System.out.println(NewCObj2.bChain.lastBlocksList[0].nonce);
        ...
        NewCoin_Malicious NewCObj3 = new NewCoin_Malicious();
        NewCObj3.pendingTransactions = new TransactionQueue();
        NewCObj3.bChain = new BlockChain_Malicious();
        NewCObj3.bChain.lastBlocksList = new TransactionBlock[100];
        NewCObj3.bChain.tr_count = 8;
        ...
        NewCObj3.memberlist = new Members[6];
        NewCObj3.memberlist[0] = M_1;
        NewCObj3.memberlist[1] = M_2;
        NewCObj3.memberlist[2] = M_3;
        NewCObj3.memberlist[3] = M_4;
        NewCObj3.memberlist[4] = M_5;
        NewCObj3.memberlist[5] = M_6;
        
        try {
            mod.initializeNewCoin(NewCObj3, 24);
        } catch (Exception e) {
            System.out.println(e);
        }
        System.out.println(NewCObj3.bChain.lastBlocksList[0].dgst);
        System.out.println(NewCObj3.bChain.lastBlocksList[0].nonce);
	System.out.println(printNewCObj(NewCObj3));




    
    NewCoin_Honest obj = makeHonestObj(4, 8);
	Moderator Mood = new Moderator();
	Mood.initializeNewCoin(obj, 32);
	for (int i = 0; i < 10; i ++){
	...
	System.out.println(printNewCObj(obj));
    ...
    public static String printNewCObj (NewCoin_Honest o){
    ...
    public static String printNewCObj (NewCoin_Malicious o){
    ...
    public static String printLists (Pair<List<Pair<String, String>>, List<Pair<String, String>>> lists){
        ...
        public static NewCoin_Honest makeHonestObj (int memnum, int trcount){
        NewCoin_Honest obj = new NewCoin_Honest();
